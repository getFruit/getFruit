...
public class SplashActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (userManager.getCurrentUser() != null) {
			...
			boolean isCache = query.hasCachedResult(SplashActivity.this,FruitShop.class);
			if(isCache){
			...
			query.setMaxCacheAge(TimeUtil.MONTH);
			query.findObjects(SplashActivity.this, new FindListener<FruitShop>() {
