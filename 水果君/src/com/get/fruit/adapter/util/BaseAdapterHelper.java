...
public class BaseAdapterHelper {
	...
	public BaseAdapterHelper setImageBitmapFromBmobFile(int viewId,
			BmobFile file) {
		ImageView view = retrieveView(viewId);
	...
	public BaseAdapterHelper setImageThumbnailFromBmobFile(int viewId,
			BmobFile file) {
		ImageView view = retrieveView(viewId);
		Log.i("baseadapter", "loadImageThumbnail  " + view.getWidth() + "  "
				+ view.getHeight());
		file.loadImageThumbnail(context, view, view.getWidth(),
				view.getHeight());
		return this;
	}
	...
	/**
	 * Sets the OnCheckedChangeListener of the view.
	 * 
	 * @param viewId
	 *            The view id.
	 * @param listener
	 *            The OnCheckedChangeListener;
	 * @return The BaseAdapterHelper for chaining.
	 */
