...
public class CityPicker extends LinearLayout {
	public OnSelectListener onProvinceSelectListener;
	public OnSelectListener onCitySelectListener;
	/** 滑动控件 */
	...
	public OnSelectListener getOnProvinceSelectListener() {
		return onProvinceSelectListener;
	}

	public void setOnProvinceSelectListener(
			OnSelectListener onProvinceSelectListener) {
		this.onProvinceSelectListener = onProvinceSelectListener;
	}

	public OnSelectListener getOnCitySelectListener() {
		return onCitySelectListener;
	}

	public void setOnCitySelectListener(OnSelectListener onCitySelectListener) {
	...
	protected void onFinishInflate() {
		...
		LayoutInflater.from(getContext()).inflate(R.layout.include_city_picker, this);
		...
		onProvinceSelectListener = new OnSelectListener() {
		...
		provincePicker.setOnSelectListener(onProvinceSelectListener);
		onCitySelectListener = new OnSelectListener() {
		...
		cityPicker.setOnSelectListener(onCitySelectListener);
	...
	public OnSelectingListener getOnSelectingListener() {
		return onSelectingListener;
	}
	...
	public ScrollerNumberPicker getProvincePicker() {
		return provincePicker;
	}

	public void setProvincePicker(ScrollerNumberPicker provincePicker) {
		this.provincePicker = provincePicker;
	}
	...
	public void setCityPicker(ScrollerNumberPicker cityPicker) {
		this.cityPicker = cityPicker;
	}

	public ScrollerNumberPicker getCounyPicker() {
		return counyPicker;
	}

	public void setCounyPicker(ScrollerNumberPicker counyPicker) {
		this.counyPicker = counyPicker;
	}
